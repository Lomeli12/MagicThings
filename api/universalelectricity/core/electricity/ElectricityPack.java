...
public class ElectricityPack implements Cloneable {
    ...
    public static ElectricityPack merge(ElectricityPack... packs) {
        ...
        return ElectricityPack.getFromWatts(totalEnergy, totalVoltage
                / packs.length);
    }
    ...
    public static ElectricityPack max(ElectricityPack... packs) {
        ...
        for (ElectricityPack pack : packs) {
            if (optimalPack == null
                    || (optimalPack != null && pack.getWatts() > optimalPack
                            .getWatts())) {
                optimalPack = pack;
            }
        }
    ...
    public String toString() {
        return "ElectricityPack [Amps:" + this.amperes + " Volts:"
                + this.voltage + "]";
    }
    ...
    public boolean isEqual(ElectricityPack electricityPack) {
        return this.amperes == electricityPack.amperes
                && this.voltage == electricityPack.voltage;
    }
}
