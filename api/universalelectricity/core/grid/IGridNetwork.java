 ...
 * 
 * @param <N>
 *            - the class/interface Type value in which you implement this
 * @param <C>
 *            - the class/interface Type which makes up the network's conductor
 *            Set
 * @param <A>
 *            - the class/interface Type which makes up the network's acceptor
 *            Set
 */
