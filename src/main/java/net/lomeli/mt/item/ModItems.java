...
import net.lomeli.mt.item.special.ItemTileCapsule;
...
public class ModItems {
    ...
    public static Item flyingRing, medKit, shaver, error, upgrades, peaceTreaty, portaCraft, liquidReader, condenseBag, record, wrench, tankUpgrade, runningShoes, tileCapsule;
    ...
    public static void loadItems() {
        ...
        runningShoes = new ItemRunningShoes(ItemInfo.runningShoesID);
        tileCapsule = new ItemTileCapsule(ItemInfo.tileCapsuleID);
