...
public class ItemCable extends ItemMT {
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;

    public int blockID;

    public ItemCable(int id) {
        super(id, "cable");
        this.setUnlocalizedName("cable");
        blockID = BlockInfo.cableID;
    }
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
        ...
        if (par1ItemStack.stackSize == 0)
            ...
            if (placeBlockAt(par1ItemStack, par2EntityPlayer, par3World, par4, par5, par6, par7, par8, par9, par10, k1)) {
                par3World.playSoundEffect((double) ((float) par4 + 0.5F), (double) ((float) par5 + 0.5F), (double) ((float) par6 + 0.5F), Block.soundClothFootstep.getPlaceSound(),
