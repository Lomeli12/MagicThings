...
public class EntityClicker extends EntityMob {
    ...
    protected void onDeathUpdate() {
        super.onDeathUpdate();
        if (this.worldObj.getBlockId((int) this.posX, (int) this.posY, (int) this.posZ) == 0 && !this.isChild() && !this.isBurning()) {
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        if (!super.attackEntityFrom(par1DamageSource, par2)) {
            ...
            if (entitylivingbase == null && par1DamageSource.getSourceOfDamage() instanceof EntityArrow) {
                this.damageEntity(DamageSource.causeArrowDamage((EntityArrow) par1DamageSource.getSourceOfDamage(), entitylivingbase), 1.5F);
            }

            if (entitylivingbase != null && this.worldObj.difficultySetting >= 3 && this.rand.nextFloat() < this.getEntityAttribute(field_110186_bp).getAttributeValue()) {
    ...
    public EntityLivingData onSpawnWithEgg(EntityLivingData par1EntityLivingData) {
        ...
        if (par1EntityLivingData1 == null) {
            par1EntityLivingData1 = new EntityClickerGroupData(this, this.worldObj.rand.nextFloat() < 0.05F, this.worldObj.rand.nextFloat() < 0.05F, (EntityClickerINNER1) null);
        }
