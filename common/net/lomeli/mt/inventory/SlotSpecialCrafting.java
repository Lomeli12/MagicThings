...
public class SlotSpecialCrafting extends SlotCrafting {
    ...
    public SlotSpecialCrafting(EntityPlayer par1EntityPlayer, IInventory par2iInventory, IInventory par3iInventory, int par4,
            int par5, int par6) {
    ...
    public void onPickupFromSlot(EntityPlayer par1EntityPlayer, ItemStack par2ItemStack) {
        ...
        if(!par1EntityPlayer.capabilities.isCreativeMode) {
            if(par1EntityPlayer.inventory.getCurrentItem().itemID == ModItems.portaCraft.itemID) {
                par1EntityPlayer.inventory.getCurrentItem().setItemDamage(
                        par1EntityPlayer.inventory.getCurrentItem().getItemDamage() + 1);
            }
        }
    }
