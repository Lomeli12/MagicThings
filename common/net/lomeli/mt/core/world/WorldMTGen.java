...
public class WorldMTGen implements IWorldGenerator {
    ...
    private void generateSurface(World world, Random random, int chunkX, int chunkZ) {
        ...
        new WorldGenMinable(ModBlocks.stamaticOre.blockID, BlockInfo.stamaticOreGen * 2).generate(world, random, xCoord,
                random.nextInt(70), zCoord);
        new WorldGenMinable(ModBlocks.igniousOre.blockID, BlockInfo.igniousOreGen * 2).generate(world, random, xCoord,
                random.nextInt(50), zCoord);
        ...
        new WorldGenMinable(ModBlocks.neoOre.blockID, BlockInfo.neoOreGen * 2).generate(world, random, xCoord,
                random.nextInt(30), zCoord);
    }
