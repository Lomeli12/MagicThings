...
public class ItemMagnet extends ItemMT {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List infoList, boolean bool) {
        if(itemStack != null)
            infoList.add((ItemInfo.magnetDurability - NBTUtil.getInt(itemStack, "magnetDamage")) + "/"
                    + ItemInfo.magnetDurability);
    }
        ...
        if(entity != null && itemStack != null) {
            ...
            if(NBTUtil.getInt(itemStack, "magnetDamage") > ItemInfo.magnetDurability)
                ...
                if(entity instanceof EntityPlayer) {
                    ...
                    if(!world.isRemote) {
                        List entityList = world.getEntitiesWithinAABBExcludingEntity(entity,
                                entity.boundingBox.expand(15.0D, 15.0D, 15.0D));
