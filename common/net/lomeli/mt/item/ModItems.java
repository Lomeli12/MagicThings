...
public class ModItems {
    public static Item ironStick, ironRing, baseMaterial, advMaterial, quantumMaterial, ingotStamatic, herb, ingotAqua,
            dustStamatic, dustAqua, emptyCase, neoGem, ingotIgnious, dustIgnious, purifiedDust;
    ...
    public static Item flyingRing, medKit, shaver, error, energyTap, upgrades, magnet, peaceTreaty, portaCraft, mountTool, toast,
            liquidReader, condenseBag, record, wrench, crank, wandCommand, ikenoBlade, tankUpgrade;
