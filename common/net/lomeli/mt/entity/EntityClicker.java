...
import net.lomeli.mt.entity.ai.EntityAINearestTarget;
...
public class EntityClicker extends EntityMob {
    ...
    protected static final Attribute field_110186_bp = (new RangedAttribute("zombie.spawnReinforcements", 0.0D, 0.0D, 1.0D))
            .func_111117_a("Spawn Reinforcements Chance");
    private static final UUID babySpeedBoostUUID = UUID.fromString("B9766B59-9566-4402-BC1F-2EE2A276D836");
    private static final AttributeModifier babySpeedBoostModifier = new AttributeModifier(babySpeedBoostUUID, "Baby speed boost",
            0.5D, 1);
    ...
    public EntityClicker(World par1World) {
        super(par1World);
        ...
        this.targetTasks.addTask(2, new EntityAINearestTarget(this, EntityPlayer.class, 0, true));
        this.setTargetable(EntityVillager.class, 0, 1.0D);
        this.setTargetable(EntityCreeper.class, 0, 1.0D);
        this.setTargetable(EntityPigZombie.class, 0, 1.0D);
        this.setTargetable(EntityWitch.class, 0, 1.0D);
        this.setTargetable(EntityEnderman.class, 0, 1.0D);
        this.setTargetable(EntityIronGolem.class, 0, 1.005D);
        this.setTargetable(EntitySnowman.class, 0, 1.0D);
        this.setTargetable(EntityWolf.class, 0, 1.0D);
        this.setTargetable(EntityAnimal.class, 0, 1.0D);
        this.setTargetable(EntitySlime.class, 0, 1.0D);
        this.setTargetable(EntitySpider.class, 0, 1.0D);
        this.setTargetable(EntityBlaze.class, 0, 1.0D);
    }

    protected int placedBlock;

    public void incrementTargetTick() {
        this.targetTick++;
    }
    ...
    public void setTargetTick(int par1) {
        this.targetTick = par1;
    }

    @SuppressWarnings("rawtypes")
    public void setTargetable(Class class1, int par1, double par2) {
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, class1, par1, false));
        this.tasks.addTask(3, new EntityAIAttackOnCollide(this, class1, par2, true));
    }

    @Override
    protected void applyEntityAttributes() {
        super.applyEntityAttributes();
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setAttribute(15.0D);
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setAttribute(0.345000000000000064D);
    ...
    protected void onDeathUpdate() {
        super.onDeathUpdate();
        if(this.worldObj.getBlockId((int) this.posX, (int) this.posY, (int) this.posZ) == 0 && !this.isChild()
                && !this.isBurning()) {
            if(this.placedBlock == 0) {
                this.worldObj.setBlock((int) this.posX, (int) this.posY, (int) this.posZ, ModBlocks.infectedBlock.blockID);
                this.placedBlock++;
            }
        }
    }
            ...
            if(this.worldObj.isDaytime() && !this.worldObj.isRaining() && !this.worldObj.isThundering()) {
                if(this.getHealth() > (this.getMaxHealth() / 2)) {
                    ...
                    if(f > 0.5F
                        ...
                        if(flag)
                            this.damageEntity(DamageSource.onFire, 1F);
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        if(!super.attackEntityFrom(par1DamageSource, par2)) {
            ...
            if(entitylivingbase == null && par1DamageSource.getSourceOfDamage() instanceof EntityArrow) {
                this.damageEntity(
                        DamageSource.causeArrowDamage((EntityArrow) par1DamageSource.getSourceOfDamage(), entitylivingbase), 1.5F);
            }
            ...
            if(entitylivingbase != null && this.worldObj.difficultySetting >= 3
                ...
                EntityClicker entityzombie = new EntityClicker(this.worldObj);
                ...
                for(int l = 0; l < 50; ++l) {
                    ...
                    if(this.worldObj.doesBlockHaveSolidTopSurface(i1, j1 - 1, k1)
                        ...
                        if(this.worldObj.checkNoEntityCollision(entityzombie.boundingBox)
                                && this.worldObj.getCollidingBoundingBoxes(entityzombie, entityzombie.boundingBox).isEmpty()
                            ...
                            entityzombie.getEntityAttribute(field_110186_bp).applyModifier(
    ...
    public boolean attackEntityAsMob(Entity par1Entity) {
        ...
        if(flag && this.getHeldItem() == null && this.isBurning()
    ...
    protected String getLivingSound() {
        return "magicthings:mob.clicker.say";
    }

    protected String getHurtSound() {
        return "magicthings:mob.clicker.hurt";
    }

    protected String getDeathSound() {
        return "magicthings:mob.clicker.death";
    }
    ...
    public EntityLivingData onSpawnWithEgg(EntityLivingData par1EntityLivingData) {
        ...
        if(par1EntityLivingData1 == null) {
            par1EntityLivingData1 = new EntityClickerGroupData(this, this.worldObj.rand.nextFloat() < 0.05F,
                    this.worldObj.rand.nextFloat() < 0.05F, (EntityClickerINNER1) null);
        }

        if(par1EntityLivingData1 instanceof EntityClickerGroupData) {
            EntityClickerGroupData entityzombiegroupdata = (EntityClickerGroupData) par1EntityLivingData1;
        ...
        this.getEntityAttribute(SharedMonsterAttributes.followRange).applyModifier(
                new AttributeModifier("Random zombie-spawn bonus", this.rand.nextDouble() * 1.5D, 2));
    ...
    public boolean interact(EntityPlayer par1EntityPlayer) {
        ...
        if(itemstack != null && itemstack.getItem() == Item.appleGold && itemstack.getItemDamage() == 0 && this.isVillager()
