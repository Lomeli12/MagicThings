...
public class ModEntities {
    ...
    private static void registerEntity(Class<? extends Entity> entityClass, String entityName, int j, int bkEggColor,
            int fgEggColor) {
        int id = EntityRegistry.instance().findGlobalUniqueEntityId() + j;
