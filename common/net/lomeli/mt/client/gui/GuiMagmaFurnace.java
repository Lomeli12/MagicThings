...
public class GuiMagmaFurnace extends GuiFluidTank {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if(this.furnace.getMainTank().getFluid() != null) {
            ...
            info.add(this.furnace.getMainTank().getFluid().getFluid().getLocalizedName() + ": "
                    + this.furnace.getMainTank().getFluidAmount() + "/" + this.furnace.getMainTank().getCapacity());
            if(this.furnace.getMainTank().getFluidAmount() > 0) {
                this.drawFluid(k + 112, (l + (77 - this.furnace.getLiquidScaled(71))), this.furnace.getMainTank().getFluid(), 13,
                        this.furnace.getLiquidScaled(71));
            }
