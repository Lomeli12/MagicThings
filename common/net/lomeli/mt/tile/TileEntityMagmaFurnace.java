...
public class TileEntityMagmaFurnace extends TileEntity implements ITileEnergy, ITanks, ISidedInventory, IFluidHandler {
    ...
    public int getLiquidScaled(int i) {
        return lavaTank.getFluid() != null ? (int) (((float) lavaTank.getFluid().amount / (float) (lavaTank.getCapacity())) * i)
                : 0;
    }
    ...
    public void readNBT(NBTTagCompound data) {
        ...
        FluidUtil.readFluidTankNBT(data, lavaTank, FluidRegistry.LAVA);
    ...
    public void writeNBT(NBTTagCompound data) {
        ...
        FluidUtil.writeFluidTankNBT(data, lavaTank);
    ...
    public boolean isItemValidForSlot(int i, ItemStack itemstack) {
        return inventory[i] != null ? (inventory[i].itemID == itemstack.itemID && inventory[i].getItemDamage() == itemstack
                .getItemDamage()) : true;
    }
