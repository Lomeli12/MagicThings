...
public class PotionInfection extends Potion {
    ...
    public static void setUp() {
        LanguageRegistry.instance().addStringLocalization("death.attack.infection",
                "%1$s " + StatCollector.translateToLocal("potion.magicthings:CordycepsDeath"));
        ...
        infect = new PotionInfection().setPotionName("potion.infection").setIconIndex(3, 15).setPotionName("Cordyceps");
    }
